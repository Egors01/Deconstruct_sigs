...
from deconstruct_sigs.deconstructsigs import DeconstructSigs
...
def main():
    ...
    ds = DeconstructSigs(m96vector=vector, analysis_handle='TEST',
                         use_cosmic=False, signatures_df=sig_df, cutoff=0.01,threshold=1e-3)
